...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (patient) {
...
buf.push("</ul></div></div></div><div class=\"modal-footer\"><button type=\"button\" data-dismiss=\"modal\" class=\"btn btn-default\">cancel</button><button type=\"button\" class=\"btn btn-success\">Submit</button></div></div></div></div>");}.call(this,"patient" in locals_for_with?locals_for_with.patient:typeof patient!=="undefined"?patient:undefined));;return buf.join("");
}